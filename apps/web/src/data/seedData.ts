...
/** Mock plate stocks for prototype demos (codes mirror lab-runner patterns). */
export const MOCK_PLATE_STOCKS: PlateStock[] = [
  {
...
export const MOCK_PLATE_STOCKS_BY_TYPE: Record<string, PlateStock[]> =
  MOCK_PLATE_STOCKS.reduce<Record<string, PlateStock[]>>((acc, stock) => {
