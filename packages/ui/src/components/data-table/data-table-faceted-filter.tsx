...
import { Separator } from "@adaptyv-coordination/ui/components/separator";
import { cn } from "@adaptyv-coordination/ui/lib/utils";
import type { Option } from "@adaptyv-coordination/types/data-table";
...
export function DataTableFacetedFilter<TData, TValue>({
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger render={<Button variant="outline" size="sm" className="border-dashed font-normal" />}>{selectedValues?.size > 0 ? (
                      <div
                        role="button"
