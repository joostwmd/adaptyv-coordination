...
import { Slider } from "@adaptyv-coordination/ui/components/slider";
...
export function DataTableSliderFilter<TData>({
  ...
  return (
    <Popover>
      <PopoverTrigger render={<Button variant="outline" size="sm" className="border-dashed font-normal" />}>{columnFilterValue ? (
                      <div
                        role="button"
